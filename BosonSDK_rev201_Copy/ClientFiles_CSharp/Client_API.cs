...
namespace Boson {
	...
	// Begin Module gao
		...
		public FLR_RESULT gaoSetRpmState(FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.GaoSetRpmState(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoGetRpmState(out FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.GaoGetRpmState(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoGetRpmThreshold(out UInt16 threshold){
			FLR_RESULT returncode = ClientPackager.GaoGetRpmThreshold(this, out threshold);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
