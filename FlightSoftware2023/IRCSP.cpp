...
void IRCSP::check_telemetry (time_t bootTime)
{
    ...
    myfile15 >> lensVal;
    std::fstream myfile16("/mnt/sdcard/image_data/thermtemp1.txt", std::ios_base::in);
    myfile16 >> therm_temp;
    std::fstream myfile17("/mnt/sdcard/image_data/context_temp.txt", std::ios_base::in);
    myfile17 >> context_temp;
    std::fstream myfile18("/mnt/sdcard/image_data/lens_temp.txt", std::ios_base::in);
    myfile18 >> lens_temp;
    std::fstream myfile19("/mnt/sdcard/image_data/heat_temp.txt",std::ios_base::in);
    myfile19 >> heat_temp;
    std::fstream myfile20("/mnt/sdcard/image_data/heat_V.txt",std::ios_base::in);
    myfile20 >> heat_V;
}
